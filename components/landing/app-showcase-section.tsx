          ...
          >
            <div className="relative w-full max-w-[900px]">
              ...
              <div className="relative  group">
                ...
                <div className="bg-gradient-to-b from-gray-300 to-gray-400 h-12 rounded-b-2xl flex items-center justify-center relative">
                ...
                <div className="flex justify-center">
                  <div className="w-18 h-16 bg-gradient-to-b from-gray-300 to-gray-400 rounded-b-lg relative">
                    {/* Stand base */}
