  ...
  return (
    <section id="showcase" className="py-24 md:py-32 bg-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="relative w-full max-w-[900px]">
              ...
              <div className="relative  group">
                ...
                {/* Screen with silver bezel */}
                <div className="bg-linear-to-b shadow-2xl from-gray-300 to-gray-400 rounded-t-2xl p-2" style={{ boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.5), 0 0 0 1px rgba(0, 0, 0, 0.1)' }}>
                ...
                <div className="bg-linear-to-b from-gray-300 to-gray-400 h-12 rounded-b-2xl flex items-center justify-center relative">
                ...
                <div className="flex justify-center">
                  <div className="w-18 h-16 bg-linear-to-b from-gray-300 to-gray-400 rounded-b-lg relative">
                    {/* Stand base */}
                    <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-40 h-2 bg-linear-to-b from-gray-400 to-gray-500 rounded-full"></div>
                  </div>
                </div>
              </div>
            </div>
        ...
        >
          <div className="inline-flex items-center gap-3 px-8 py-4 rounded-full bg-linear-to-r from-slate-800 to-slate-900 shadow-lg border border-slate-700/50 relative overflow-hidden">
            {/* Subtle glow effect */}
